...
export const Quizlisting: React.FC = (props: IAppProps) => {
                ...
                <div className='question-page-components'>
                  <div className='question-page-upper-component'>
                    <h1 className='question-number'>
                      Question : {count + 1} / {statetotal.allquestion}
                    </h1>
                    <h1 className='question-score'>
                  ...
                  <div className='question-buttons'>
                    <Link
                      to={count === 9 ? redirectback : redirect}
                      onClick={() => {
                        stateDispatch({ type: "INCREMENT", payload: 0 });
                        stateDispatch({
                          type: "CORRECT_FRIENDS_QUIZ",
                          payload: 4,
                        });
                        setCount(count + 1);
                      }}
                      className='question-phrase-button '>
                      {friends[count].option1}
                    </Link>
                    <Link
                      to={count === 9 ? redirectback : redirect}
                      onClick={() => {
                        stateDispatch({ type: "INCREMENT", payload: 0 });
                        stateDispatch({
                          type: "WRONG_FRIENDS_QUIZ",
                          payload: 1,
                        });
                        setCount(count + 1);
                      }}
                      className='question-phrase-button'>
                      {friends[count].option2}
                    </Link>
                    <Link
                      to={count === 9 ? redirectback : redirect}
                      onClick={() => {
                ...
                <div className='question-page-components'>
                  ...
                  <div className='question-buttons'>
                    <Link
                      ...
                      onClick={() => {
                        stateDispatch({ type: "INCREMENT", payload: 0 });
                        stateDispatch({ type: "WRONG_SUITS_QUIZ", payload: 1 });
                        setCount(count + 1);
                      }}
                      className='question-phrase-button '>
                      {Suits[count].option1}
